...
$messages['passwordchanged'] = "Your password was updated";
...
$messages['title'] = "Password Update";
$messages['login'] = "Login";
$messages['oldpassword'] = "Current password";
$messages['newpassword'] = "New password";
$messages['confirmpassword'] = "Confirm new password";
$messages['submit'] = "Send";
$messages['getuser'] = "Get user";
$messages['tooshort'] = "Invalid password: the length must be at least 8 characters and contain at least one number and one non-alphanumeric character";
$messages['toobig'] = "Your password is too big";
$messages['minlower'] = "Invalid password: the length must be at least 8 characters and contain at least one number and one non-alphanumeric character";
$messages['minupper'] = "Invalid password: the length must be at least 8 characters and contain at least one number and one non-alphanumeric character";
$messages['mindigit'] = "Invalid password: the length must be at least 8 characters and contain at least one number and one non-alphanumeric character";
$messages['minspecial'] = "Invalid password: the length must be at least 8 characters and contain at least one number and one non-alphanumeric character";
...
$messages['mailnomatch'] = "Login or password incorrect";
$messages['tokensent'] = "A confirmation email has been sent. Please click on the link to reset your password.";
$messages['tokennotsent'] = "Error when sending confirmation email";
$messages['tokenrequired'] = "Token is required";
$messages['tokennotvalid'] = "Token is not valid. To get a new token please <a href=\"?action=sendtoken\">click here</a>.";
...
$messages['changesubject'] = "Your password has been updated";
