...
$messages['passwordchanged'] = "Su contraseña ha sido actualizada";
$messages['nomatch'] = "Las contraseñas difieren";
$messages['badcredentials'] = "Error: nombre de usuario o contraseña incorrecta";
$messages['passworderror'] = "Su contraseña fue rechazada";
$messages['title'] = "Actualizar contraseña";
$messages['login'] = "Nombre de usuario";
$messages['oldpassword'] = "Contraseña actual";
$messages['newpassword'] = "Nueva contraseña";
$messages['confirmpassword'] = "Confirmar nueva contraseña";
$messages['submit'] = "Enviar";
$messages['tooshort'] = "Contraseña inválida: la longitud debe ser de al menos de 8 caracteres, contener al menos un número y un carácter no alfanumérico";
...
$messages['mindigit'] = "Contraseña inválida: la longitud debe ser de al menos de 8 caracteres, contener al menos un número y un carácter no alfanumérico";
$messages['minspecial'] = "Contraseña inválida: la longitud debe ser de al menos de 8 caracteres, contener al menos un número y un carácter no alfanumérico";
...
$messages['mailnomatch'] = "Error: nombre de usuario o contraseña incorrecta";
$messages['tokensent'] = "Hemos enviado un mensaje a su e-mail, haga clic en el enlace para restablecer su contraseña.";
$messages['tokennotsent'] = "Error al enviar el correo de confirmación";
$messages['tokenrequired'] = "Un código es requerido";
$messages['tokennotvalid'] = "El código no es válido. Para obtener un nuevo código haga <a href=\"?action=sendtoken\">clic aquí</a>.";
...
$messages['changesubject'] = "Su contraseña ha sido actualizada";
...
$messages['emptysendtokenform'] = "Resetear con mi e-mail";
